...
const experiences = [
  {
    ...
    period: "2021 - 2025",
    description: "Focused on software development, and web technologies. Participated in coding competitions and technical projects.",
    highlights: ["Web Development", "Database Management"],
  ...
  },
  {
    ...
    highlights: ["4+ Complete Projects", "Multiple Tech Stacks", "Problem-Solving Focus"],
